    ...
    <>
      ...
      <View style={selected? styles.greencard : styles.redcard}>
        ...
        <View style={styles.insidecard}>
          <View>
            <Text style={styles.textBold}>{order_element.dish} (x {order_element.quantity}) - [{order_element.price_corrected? order_element.new_price_corrected: order_element.dish_price} €]</Text>
          </View>
        </View>
      </View>
      </TouchableOpacity>
