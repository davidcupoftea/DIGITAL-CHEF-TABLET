...
import RegistroYFacturaInList from "./RegistroYFacturaInList.jsx";
...
const Registros = ({ route }) => {
  ...
  const [registrosyfacturas, setRegistros] = useState(null);
    ...
    <View style={styles.ofertas}>
      {WARNING_NOT_SCROLLABLE ? (
        <Text style={styles.textsmall}>
          Estás viendo los registros y facturas del restaurante{" "}
      ...
      <ScrollView>
        ...
        {loaded &&
        !loading &&
        registrosyfacturas != null &&
        registrosyfacturas.length == 0 ? (
          <Text style={styles.textsmall}>No hay registros y facturas</Text>
        ) : null}
      </ScrollView>
    </View>
  );
