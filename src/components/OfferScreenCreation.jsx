...
const OfferScreen = (variable) => {
  ...
  const createOffer = async (restaurantChosen_pk) => {
    setDisabled(true);
    ...
    if (
      ...
      Alert.alert(
        ...
        "(Puedes dejar el código vacío, así como la media, el descuento y los productos asociados)"
      );
      return;
    }
    ...
    const res4 = await fetch(
      BASE_URL + "crear-oferta-digital-chef/" + restaurantChosen_pk + "/",
      {
        method: "POST",
        headers: {
    ...
    if (jsonData4.status == "ok") {
      Alert.alert("Éxito", "Se ha creado la oferta");
      navigation.goBack();
      setDisabled(false);
    ...
    <>
      <ScrollView>
        <View style={styles.viewable}>
          ...
          <View>
            <Text style={styles.text}>
              PK del producto (o productos) asociados a esta oferta
            </Text>
            <TextInput
          ...
          <View>
            <Text style={styles.text}>
              Porcentaje de descuento al producto asociado
            </Text>
            <TextInput
              keyboardType="numeric"
              style={styles.textinput}
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              createOffer(restaurantChosen.pk);
            }}
          >
