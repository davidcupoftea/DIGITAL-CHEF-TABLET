        ...
        <View style={styles.insidecard}>
          ...
          <View><Text style={styles.text}>Pedido:</Text>
            {factura.order_elements.length > 0 ? factura.order_elements.map((element, index)=>(
              <Text style={factura.negative? styles.textred :null} key={index}>{element.dish} (x{element.quantity}) [ID:{element.dish_pk}] - {element.new_price_corrected?element.new_price_corrected:element.dish_price} €</Text>
