...
const Facturas = ({ route }) => {
  ...
  const fetchFacturasByDateOrNoDate = async () => {
    if (authTokens != null && authTokens != "null" && filterByDateCheckBox) {
      ...
      if (orderDateString != "") {
        fetchFacturasByDate(restaurantChosen_pk);
      } else {
      ...
      fetchFacturas(restaurantChosen_pk);
    }
  };
    ...
    <View style={styles.ofertas}>
      {WARNING_NOT_SCROLLABLE ? (
        <Text style={styles.textsmall}>
          Estás viendo las facturas del restaurante {restaurantChosen.franchise}{" "}
      ...
      <ScrollView>
        {!WARNING_NOT_SCROLLABLE ? (
          <Text style={styles.textsmall}>
            Estás viendo las facturas del restaurante{" "}
        ...
        <BouncyCheckbox
          ...
          onPress={(checking) => {
            if (orderDateString == "") {
              if (!checking == false) {
                setFilterByDateCheckBox(!checking);
              } else {
                Alert.alert(
                  "No puedes marcar esta casilla antes de poner una fecha"
                );
              }
            } else {
