      ...
      <ScrollView>
        {loading ? (
          ...
          {restaurants.map((restaurant, index)=>(
            <View key={index} style={!restaurantsAlreadyClaimed.includes(restaurant.restaurant.pk)? styles.card: styles.greencard}>
              ...
              {restaurantsAlreadyClaimed.includes(restaurant.restaurant.pk)? <Text style={styles.textsmallgreen}>Ya has reclamado la vinculación con este restaurante</Text>:null}

              {!restaurantsAlreadyClaimed.includes(restaurant.restaurant.pk)?<TouchableOpacity style={styles.button} onPress={()=>{selectRestaurant(restaurant.restaurant.pk)}}><Text style={styles.textbutton}>Pedir pertenencia a restaurante</Text></TouchableOpacity>:null}
